...
(defun base16-theme-define (theme-name theme-colors)
  ...
  (base16-set-faces
   ...
   '(;; Built in stuff (Emacs 23)
     ...
     (mode-line                                    :foreground base04 :background base01 :box (:line-width 8 :color base01 :style unspecified))
     ...
     ;; which-function
     (which-func                                   :foreground base0D :background nil)
     ...
     (helm-buffer-directory                        :foreground base04 :background nil :weight semi-bold)
     ...
     (helm-ff-directory                            :foreground base0D :background nil)
     (helm-ff-executable                           :foreground base0B)
     (helm-ff-file                                 :foreground base06)
